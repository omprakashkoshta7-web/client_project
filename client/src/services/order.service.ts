...
class OrderService {
  ...
  async getCart() {
    try {
      ...
      const response = await productionApiClient.get('/api/orders/cart');
  ...
  async addToCart(data: {
    ...
    try {
      ...
      const response = await productionApiClient.post('/api/orders/cart', data);
  ...
  async updateCartItem(itemId: string, quantity: number) {
    try {
      ...
      const response = await productionApiClient.patch(`/api/orders/cart/${itemId}`, { quantity });
  ...
  async removeCartItem(itemId: string) {
    try {
      ...
      const response = await productionApiClient.delete(`/api/orders/cart/${itemId}`);
  ...
  async createOrder(data: CreateOrderData): Promise<{ success: boolean; data: Order; message: string }> {
    try {
      ...
      const response = await productionApiClient.post(API_CONFIG.ENDPOINTS.ORDERS.CREATE, data);
  ...
  async createPrintingOrder(data: CreateOrderData): Promise<{ success: boolean; data: Order; message: string }> {
    try {
      ...
      const response = await productionApiClient.post('/api/printing/orders', data);
  ...
  async createGiftingOrder(data: CreateOrderData): Promise<{ success: boolean; data: Order; message: string }> {
    try {
      ...
      const response = await productionApiClient.post('/api/gifting/orders', data);
  ...
  async createShoppingOrder(data: CreateOrderData): Promise<{ success: boolean; data: Order; message: string }> {
    try {
      ...
      const response = await productionApiClient.post('/api/shopping/orders', data);
  ...
  async getMyOrders(params?: { 
    ...
    try {
      ...
      const response = await productionApiClient.get(API_CONFIG.ENDPOINTS.ORDERS.MY_ORDERS, { params });
  ...
  async getOrderById(orderId: string): Promise<{ success: boolean; data: Order }> {
    try {
      ...
      const response = await productionApiClient.get(API_CONFIG.ENDPOINTS.ORDERS.ORDER_BY_ID(orderId));
  ...
  async getOrderSummary(): Promise<{ success: boolean; data: OrderSummary }> {
    try {
      ...
      const response = await productionApiClient.get('/api/orders/summary');
  ...
  async trackOrder(orderId: string): Promise<{ success: boolean; data: TrackingView }> {
    try {
      ...
      const response = await productionApiClient.get(API_CONFIG.ENDPOINTS.ORDERS.TRACK(orderId));
  ...
  async getEditWindow(orderId: string): Promise<{ success: boolean; data: OrderEditWindow }> {
    try {
      ...
      const response = await productionApiClient.get(`/api/orders/${orderId}/edit-window`);
  ...
  async updateBeforeProduction(
    ...
    try {
      ...
      const response = await productionApiClient.patch(`/api/orders/${orderId}/before-production`, data);
  ...
  async reorder(orderId: string): Promise<{ success: boolean; data: Order; message: string }> {
    try {
      ...
      const response = await productionApiClient.post(`/api/orders/${orderId}/reorder`);
  ...
  async respondClarification(
    ...
    try {
      ...
      const apiResponse = await productionApiClient.post(`/api/orders/${orderId}/clarification/respond`, { response });
